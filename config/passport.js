...
let comparePasswordAsync = promisify(bcrypt.compare);
...
module.exports = function(app, passport) {
  ...
  passport.deserializeUser(function(id, done) {
    User.find({ where: { id: id }, include: { model: UserRole, as: 'UserRoles' } }).then(function(user) {
      done(null, user);
    });
  });
      ...
      function(req, email, password, done) {
        ...
        process.nextTick(function() {
          ...
          if (password !== req.body.confirmPassword) {
            ...
            return done(null, false, req.flash(msgConstants.REGISTER, 'Passwords do not match'));
          }
          ...
          User.find({ where: { email: email } }).then(function(user) {
            ...
            if (user) {
              return done(null, false, req.flash(msgConstants.REGISTER, 'That email is already taken.'));
            }
            ...
            hashAsync(password, 10)
              ...
              .catch(function(err) {
                ...
                return done(null, false, req.flash(msgConstants.REGISTER, err.errors[0].value));
              });
          });
        });
      }
        ...
        process.nextTick(function() {
          ...
          User.find({ where: { email: email } })
            ...
            .catch(function() {
              ...
              return done(null, false, req.flash(msgConstants.LOGIN, 'Invalid email or password'));
            });
        });
      }
    )
